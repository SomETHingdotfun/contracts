...
contract UIHelper is ReentrancyGuard, IERC721Receiver {
    ...
    returns (uint256 amountOut)
  {
    ...
    amountOut = adapter.swapWithExactInput(fundingToken, _tokenOut, _amountIn, _minAmountOut, 0);
    ...
    returns (uint256 amountSwapOut)
  {
    ...
    amountSwapOut = adapter.swapWithExactInput(_tokenIn, fundingToken, _amountToSell, _odosParams.tokenAmountIn, 0);
